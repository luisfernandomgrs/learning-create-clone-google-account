...
import { Checkbox, Button, Box, TextField, InputAdornment } from '@mui/material';
import "./App.css";
    ...
    <>
      <div style={{ display: "flex", width: "430px" }}>
        <div style={{ textAlign: "left" }}>
          ...
          <h2 style={{ fontWeight: 500 }}>Create your Google Account</h2>
          <Box
            component="form"
            noValidate
            autoComplete="off"
          >
            <TextField id="firstName" label="First name" variant="outlined" size='small' style={{ with: "45%", marginRight: "2%" }} />
            <TextField id="lastName" label="Last name" variant="outlined" size='small' style={{ with: "45%" }} />
          </Box>
          ...
          >
            <TextField id="outlined-basic" label="User name" variant="outlined" size='small' fullWidth
              InputProps={{
                endAdornment: (
          ...
          <div>
            <Button variant="text" style={{ textTransform: "none", fontWeight: 600 }}>Use my current email address instead</Button>
          </div>
          <Box
            component="form"
            noValidate
            ...
            style={{ marginTop: "40px" }}
          >
            <TextField id="password" label="Password" variant="outlined" size='small' style={{ with: "45%" }} />
            <TextField id="confirmPassword" label="Confirm" variant="outlined" size='small' style={{ with: "45%", marginLeft: "2%" }} />
          </Box>
          <div style={{ color: "rgd(95, 99, 104)", fontSize: "12px", padding: "10px" }}>
          ...
          >
            <Button variant="text" style={{ textTransform: "none", fontWeight: 500 }}>Sign in instead</Button>
